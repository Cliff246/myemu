...
/*we could define it so that each instruction is defined in the assembler twice.
//as a pneumonic and as the solution solver,
//this way each instruction is defined using a 'template' and then is converted using the 'syntax'
//of the assembler into the actual instruction 'type' this is then converted AGAIN into the binary form
//WHY? honestly idk... but this is the immediate gut feeling that this is right. mostly due to syntax differences
//as in, syntax's like at&at and Intel as well as arm/mips/risc-5 are all defined using their proper syntax rules.
//however the actual binary instruction is treated as a 'general system'
//
//like a class ATAT_INSTRUCTION: instruction and class INTEL_INSTRUCTION : instruction
//
*/
//convert to a byte instruction... 
//how to do this 
